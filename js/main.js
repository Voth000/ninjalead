...
//<canvas class="webgl" id="load"></canvas>///


////
   var dialog = ["View as computers to interact with the bike",
   "Mobile Devices is not fully supported",
     ...
     "Mobile Devices is not fully supported",
      ...
      let displayIndex = 0;
        let elem = document.getElementById('pi');
        let delay = 400; // 1 second delay
...
var dia1 = [
  " {Hold click + Move around}",
"?Hover over the jelly circle?",
 ];
   let displayIndex1 = 0;
     let elem1 = document.getElementById('tvt1');
     let delay1 = 1500; // 1 second delay
     
     setInterval(() => {
       if (elem1) {
        elem1.innerHTML = dia1[displayIndex1];
      }
      displayIndex1++;
       
     if (displayIndex1 >= dia1.length) {
        displayIndex1 = 0;
      }
     }, delay1);
